    ...
    <my:header>
        <c:if test="${!hideMenu}">
            <div id="headerMenu">
                ...
                <div class="menu-link menu-item-left menu-item <c:if test="${activeMenuItem == 'elearning'}">menu-link-active</c:if>">
                    <a href="${pageContext.request.contextPath}/secure/elearning.html">
                        <span><s:message code="cmas.face.client.menu.elearning"/></span>
                    </a>
                </div>
                ...
                <ul>
                    <li class="has-sub">
                        ...
                        <ul id="menuItems">
                            ...
                            <c:choose>
                            <c:when test="${activeMenuItem == 'elearning'}">
                            <li class="menu-active">
                                </c:when>
                                <c:otherwise>
                            <li class="menu-inactive">

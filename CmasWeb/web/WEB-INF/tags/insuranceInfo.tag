...
<div class="clearfix" style="margin-bottom: 16px; margin-top: 16px">
    <img src="${pageContext.request.contextPath}/i/logo_insurance.png" alt="cmas logo"
         height="60px" style="float: left"/>

    <img src="${pageContext.request.contextPath}/i/bf_logo.png" alt="baltic finance logo"
         height="60px" style="float: right"/>
</div>
<table class="insurance-table">
    ...
    <tr>
        ...
        <td class="insurance-table-second">EUR 150.000</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">EUR 75.000</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">max. EUR 150.000</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">max. EUR 100.000</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">max. EUR 50.000</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">max. EUR 30.000</td>
    </tr>
    <tr>
        <td>Local Ambulance Expenses</td>
        <td class="insurance-table-second">max. EUR 4.000</td>
    </tr>
    <tr>
        <td>Dental Cover (Only for professional athletes for accidents during pool
            activities)
        </td>
        <td class="insurance-table-second">max. EUR 2.500</td>
    </tr>
    <tr>
        <td><b>Excess</b></td>
        <td></td>
    ...
    <tr>
        ...
        <td class="insurance-table-second">EUR 350</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="insurance-table-second">max. EUR 1.000</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Each and every claim</td>
        <td class="insurance-table-second">max. EUR 10.000</td>
    </tr>
</table>

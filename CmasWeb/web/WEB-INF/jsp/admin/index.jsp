...
<my:adminpage title="Users of AquaLink">
    ...
    <c:choose>
        <c:when test="${!empty users}">
            ...
            <c:if test="${!empty command.userRole}">
                <c:set var="url" value="${url}userRole=${command.userRole}&"/>
                <c:set var="urlEmpty" value="false"/>
            </c:if>
            ...
            <c:if test="${!empty command.countryCode}">
                <c:set var="url" value="${url}countryCode=${command.countryCode}&"/>
                <c:set var="urlEmpty" value="false"/>
            </c:if>
    ...
    <pg:pager url="${initURL}" maxIndexPages="20" maxPageItems="${command.limit}" items="${count}"
        ...
        <pg:param name="userRole"/>
        <pg:param name="diverType"/>
        <pg:param name="countryCode"/>
        <pg:param name="dir"/>
        <pg:index>

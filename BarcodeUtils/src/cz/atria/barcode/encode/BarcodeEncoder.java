	...
	private boolean encodeContentsFromZXingIntent(Intent intent)
	{
		...
		else
		{
			...
			if (data != null && data.length() > 0)
			{
				...
				title = activity.getString(R.string.barcode_contents_text);
			}
		}
	...
	private void encodeQRCodeContents(Intent intent, String type)
	{
		...
		else if (type.equals(Contents.Type.EMAIL))
		{
			...
			if (data != null)
			{
				...
				displayContents = data;
				title = activity.getString(R.string.barcode_contents_email);
			}
		}
		else if (type.equals(Contents.Type.PHONE))
		{
			...
			if (data != null)
			{
				...
				title = activity.getString(R.string.barcode_contents_phone);
			}
		}
		else if (type.equals(Contents.Type.SMS))
		{
			...
			if (data != null)
			{
				contents = "sms:" + data;
				displayContents = PhoneNumberUtils.formatNumber(data);
				title = activity.getString(R.string.barcode_contents_sms);
			}
		}
		else if (type.equals(Contents.Type.CONTACT))
		{
			...
			if (bundle != null)
			{
				...
				if (newDisplayContents.length() > 0)
				{
					...
					title = activity.getString(R.string.barcode_contents_contact);
				}
				else
				{
					contents = null;
		...
		else if (type.equals(Contents.Type.LOCATION))
		{
			...
			if (bundle != null)
			{
				...
				if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE)
				{
					...
					title = activity.getString(R.string.barcode_contents_location);
				}
			}
		}
	}
